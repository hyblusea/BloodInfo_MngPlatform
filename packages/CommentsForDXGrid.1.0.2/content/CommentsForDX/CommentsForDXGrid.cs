...
{
    partial class CommentsForDXGrid
    {
        /// <summary>
        /// 必需的设计器变量。
        /// </summary>
    ...
    public partial class CommentsForDXGrid : Component
    {
        public DevExpress.XtraGrid.GridControl Grids { get; set; }

        public CommentsForDXGrid()
        {
            InitializeComponent();
        }

        public CommentsForDXGrid(IContainer container)
        {
            container.Add(this);
    ...
    {
        private CommentsForDXGrid commentsForDx;
        ...
        {
            this.commentsForDx = component as CommentsForDXGrid;
        ...
        public DevExpress.XtraGrid.GridControl Grids
        {
            ...
            set
            {
                TypeDescriptor.GetProperties(typeof(CommentsForDXGrid))["Grids"]
